    ...
    <div class="container" style="margin-bottom: 50px;margin-top: 200px;">
        ...
        <div class="row">
            <div class="col-lg-12 mx-auto text-center">
                <h1 class="section-heading">Decretos</h1>
        ...
        <div class="row">
            <div class="col-xl-12 offset-xl-0 text-center" style="margin-bottom: 10px;margin-top: 10px;">
                <h1>Decreto 825 - Uso Prioritario de Internet (2000)</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-12 text-center">
            <embed src="http://www.conatel.gob.ve/wp-content/uploads/2017/01/sobre-internet.pdf" type="application/pdf" width="100%" height="650px" />
            </div>
            <div class="col-xl-12 text-center" style="margin-top: 30px;">
                <h5>Documento Original</h5>
                <a href="http://www.conatel.gob.ve/wp-content/uploads/2017/01/sobre-internet.pdf" target="_blank"><button type="button" class="btn btn-outline-primary"><i class="fas fa-file-download" style="margin-right: 5px;"></i>Descargar</button></a>
            </div>
            <br>
            <br><br><br><br>
            ...
            <div class="col-xl-12" style="margin-top:30px">
                <h5>Referencias</h5>
                <li>Gaceta Oficial N° 36955 (2000). Decreto 825 - Uso Prioritario de Internet  (Venezuela). Recuperado el 21 de marzo de 2021 de <a href="http://www.conatel.gob.ve/wp-content/uploads/2017/01/sobre-internet.pdf" target="_blank">http://www.conatel.gob.ve/wp-content/uploads/2017/01/sobre-internet.pdf</a></li>
            </div>
        </div>
    </div>
