    ...
    <div class="container" style="margin-bottom: 50px;margin-top: 200px;">
        ...
        <div class="row">
            <div class="col-xl-12 offset-xl-0 text-center" style="margin-bottom: 10px;margin-top: 10px;">
                <h1>Ley sobre el Derecho de Autor (1997)</h1>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xl-12 text-center" style="margin-top: 30px;">
                ...
                <a href="http://sapi.gob.ve/wp-content/uploads/2020/09/ley_derecho_de_autor.pdf" target="_blank"><button type="button" class="btn btn-outline-primary"><i class="fas fa-file-download" style="margin-right: 5px;"></i>Descargar</button></a>
            </div>
            <br>
            <br><br><br><br>
            ...
            <div class="col-xl-12" style="margin-top:30px">
                <h5>Referencias</h5>
                <li>Palacio Federal Legislativo de Venezuela (1993). Ley sobre el derecho de autor. Recuperado el 14 de marzo de 2021 de <a href="http://sapi.gob.ve/wp-content/uploads/2020/09/ley_derecho_de_autor.pdf" target="_blank">http://sapi.gob.ve/wp-content/uploads/2020/09/ley_derecho_de_autor.pdf</a></li>
            </div>
        </div>
    </div>
